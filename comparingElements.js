//Initialize array with square brackets
//Arrays can be mixed-types because its in Javascript
//However mixing types in bad practice
var testArray = [0, 1, 1, "1", 3, "311"];

//comparing last 2 elements of the array
for (var arrayPosition = 0; arrayPosition < testArray.length - 1; arrayPosition++) {
	...
	if (currentElement == nextElement) {
		...
		console.log("Testing " + currentElement + " and " + nextElement + " (are equal to): false");
		}
